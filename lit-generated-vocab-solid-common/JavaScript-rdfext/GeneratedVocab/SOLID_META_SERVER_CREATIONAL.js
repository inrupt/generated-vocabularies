...
const RDFJS_NAMESPACE = namespace("https://inrupt.net/vocab/solid-meta-server-creational#");
...
const SOLID_META_SERVER_CREATIONAL = {
 ...
 term defines the root term of that graph.
   ...
   */
  hostName: RDFJS_NAMESPACE("hostName"),

  /**
   * Host IP address of the server processing this request.
   */
  hostIpAddress: RDFJS_NAMESPACE("hostIpAddress"),

  /**
   * Timestamp this server was instantiated.
   */
  createdTimestamp: RDFJS_NAMESPACE("createdTimestamp"),
